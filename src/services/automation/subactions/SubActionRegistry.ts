...
export class SubActionRegistry {
  ...
  static initialize() {
    ...
    this.register({
      ...
      description: 'Create a channel poll',
      fields: [
        { name: 'title', type: 'text', label: 'Poll Title', required: true },
        { name: 'choices', type: 'text', label: 'Choices (comma-separated)', required: true },
        { name: 'duration', type: 'number', label: 'Duration (seconds)', required: true, default: 60, min: 15, max: 1800 }
      ],
